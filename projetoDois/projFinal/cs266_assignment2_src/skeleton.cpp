...
void Skeleton::evalArc(const SkelArc* arc) const
{
  ...
  // Add the translation
//  glTranslated(arc->getTranslation()->getX(), arc->getTranslation()->getY(), arc->getTranslation()->getZ());

  // Set the angle
//  glRotated(arc->getRotationAngle()->getValue(), arc->getRotationAxis()->getX(), arc->getRotationAxis()->getY(), arc->getRotationAxis()->getZ());
