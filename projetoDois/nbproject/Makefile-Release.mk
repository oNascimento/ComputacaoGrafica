...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/projetodois
...
${OBJECTDIR}/MudarTela/Casa.o: MudarTela/Casa.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MudarTela/Casa.o MudarTela/Casa.cpp

${OBJECTDIR}/MudarTela/Lines.o: MudarTela/Lines.cpp
	${MKDIR} -p ${OBJECTDIR}/MudarTela
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/MudarTela/Lines.o MudarTela/Lines.cpp
